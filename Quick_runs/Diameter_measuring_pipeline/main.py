...
if PATH_1.endswith("png") or PATH_1.endswith("jpg") or PATH_1.endswith("tif"):
    ...
    print(f"Measured diameters in nm {first_dm_s}" if dist_bool== "No" else f"Measured diameters in px {first_dm_s}")
    ...
    print("The input file is not in the suitable format")
