...
FIN = ["/home/marilin/Documents/ESP/data/16.08.22_dead_live/control_50killed_syto_PI_2.czi"]
...
cv2.imshow("green", G)
cv2.imshow("red", R)
cv2.imwrite("green_intensities.png", G)
cv2.imwrite("red_intensities.png", R)
