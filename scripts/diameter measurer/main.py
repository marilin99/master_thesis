...
TARGET_PATH = "/home/marilin/Documents/ESP/data/fiber_tests/fiber_test_3/unet_results_2/"

#ORIG_PATH = "/home/marilin/Documents/ESP/data/fiber_tests/seed_time_test/original_data/"
...
for f in FILES:
    if f.endswith(".tif") or f.endswith(".png") or f.endswith(".jpg"):
        ...
        #     # timestamps["segmentation"] = time.time() - start_time
        ...
        # timestamps["thinning"] = time.time() - start_time
        ...
        timestamps["point picking"] = time.time() - start_time
        ...
        timestamps["scale obtaining"] = time.time() - start_time
        ...
        timestamps["dm finding"] = time.time() - start_time
        ...
        with open(f"{TARGET_PATH}{core_name}.txt", "w+") as file:
            ...
            for val in first_excs:
                file.write(f"{val}")
                file.write("\n")
            file.write(f"***timestamps***: {timestamps}")
            file.write("\n")
