...
def classical_segment(file):
    ...
    cv2.imwrite("/home/marilin/Documents/ESP/data/fiber_tests/fiber_test_1/segmented_img_class_tmp/kuwahara_1.png", np.uint8(kuwahara_img))
    ...
    tmp_h = np_thuang
    tmp_h[tmp_h == 1] = 255
    cv2.imwrite("/home/marilin/Documents/ESP/data/fiber_tests/fiber_test_1/segmented_img_class_tmp/huang_1.png", np.uint8(tmp_h))

    merged = np.uint8(cv2.medianBlur(np.uint8(np_thuang), 15)) 
    merged[merged>0] = 255
    cv2.imwrite("/home/marilin/Documents/ESP/data/fiber_tests/fiber_test_1/segmented_img_class_tmp/median_1.png", np.uint8(merged))
...
if __name__ == "__main__":
    #cv2.imwrite("/home/marilin/Documents/ESP/data/fiber_tests/fiber_test_1/segmented_img_class_tmp/EcN_PEO_111220_2k06_class_step.png", classical_segment("/home/marilin/Documents/ESP/data/fiber_tests/fiber_test_1/2k_5k_orig_images/EcN_PEO_111220_2k06.tif"))
    classical_segment("/home/marilin/Documents/ESP/data/fiber_tests/fiber_test_1/original_data/EcN_PEO_111220_20k03.tif")
    cv2.waitKey(0)
